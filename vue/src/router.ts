...
// const _VueRouter = inBrowser && ('VueRouter' in window) ? window['VueRouter'] : VueRouter;

// // Extend the official VueRouter
export class IonicRouter extends VueRouter {
  direction: any;
